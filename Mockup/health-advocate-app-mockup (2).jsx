...
import {
  ...
  MapPin, Star, Search, MessageCircle, Camera, Send, Dna, Wifi, Stethoscope, Bell
} from "lucide-react";
    ...
    <div style={{ padding: "28px 20px", minHeight: "100%" }}>
      ...
      {step === 2 && (
        <div>
                  ...
                  <div key={item.id} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "9px 0", borderBottom: `1px solid ${COLORS.border}` }}>
                    ...
                    <div style={{ display: "flex", gap: 8, alignItems: "center", flexShrink: 0 }}>
                      ...
                      <button onClick={() => setCompletedItems(p => ({ ...p, [item.id]: !p[item.id] }))} style={{ background: done ? COLORS.tealLight : "none", border: `1.5px solid ${done ? COLORS.tealLight : COLORS.border}`, borderRadius: 12, width: 24, height: 24, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center" }}>
                        {done && <CheckCircle2 size={12} color={COLORS.onAccent} />}
                      </button>
                    </div>
                  </div>
                );
          ...
          <button onClick={() => setStep(3)} style={{ width: "100%", background: COLORS.teal, border: "none", color: COLORS.onAccent, fontSize: 14, fontWeight: 700, padding: "14px", borderRadius: 12, cursor: "pointer" }}>
      ...
      {step === 3 && (
        <div>
          ...
          <button onClick={() => setStep(4)} style={{ width: "100%", background: COLORS.teal, border: "none", color: COLORS.onAccent, fontSize: 14, fontWeight: 700, padding: "14px", borderRadius: 12, cursor: "pointer" }}>
            Upload bloodwork →
          </button>
...
export default function App() {
  ...
  return (
    <div style={{
      ...
      padding: 24, minHeight: 700, display: "flex", flexDirection: "column", alignItems: "center"
    }}>
