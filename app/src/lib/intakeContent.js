...
export const INTAKE_SECTIONS = [
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "gahtSelfManagedNote", type: "note", tone: "warn", text: "Self-managed GAHT without medical oversight carries significant cardiovascular, hematologic, and bone-health risks. We strongly recommend working with a prescriber and can help identify affirming providers in your area.", showIf: (a) => a.gahtPrescriber === "Self-managed / no current prescriber" },
